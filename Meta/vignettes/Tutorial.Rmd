...
```{r import_bystander, fig.width=5, fig.height=5, fig.align="center", fig.cap="Quality control for bystander"}
...
```{r import_infected, fig.width=5, fig.height=5, fig.align="center", fig.cap="Quality control for bystander"}
...
```{r integration, message=FALSE, warning=FALSE, fig.align="center", fig.cap="Harmony Interation"}
...
```{r DimPlot, fig.height=3, fig.width=8, fig.align="center", fig.cap="Cell DimPlot"}
...
```{r DensityPlot, fig.height=3, fig.width=8, fig.align="center", fig.cap="Cell Density Plot"}
...
```{r PopulationPlot1, fig.height=3, fig.width=3, fig.align="center", fig.cap="Cell Population Plot by cluster"}
...
```{r PopulationPlot2, fig.height=3, fig.width=3, fig.align="center", fig.cap="Cell Population Plot by sample"}
scPopulationPlot(object = Integrated, 
                 by = "sample", 
                 order = c("Bystander", "Infected"))
```
...
```{r VizMetaPlot, fig.height=3.3, fig.width=10, fig.align="center", fig.cap="H3N2 DimPlot"}
...
```{r PathogenRatioPlot, fig.height=3, fig.width=4, fig.align="center", fig.cap="H3N2 Ratio Plot"}
...
```{r VolcanoPlot, fig.height=4, fig.width=4, fig.align="center", fig.cap="Volcano Plot of Infected_vs_Bystander"}
...
```{r GOBarPlot_up, fig.height=3, fig.width=6, fig.align="center", fig.cap="Infected_vs_Bystander.GO_up"}
...
```{r GOBarPlot_down, fig.height=3, fig.width=6, fig.align="center", fig.cap="Infected_vs_Bystander.GO_down"}
scGOBarPlot(object = Integrated, 
            key = "Infected_vs_Bystander.GO", 
            ont = "BP", 
            top_n = 6, 
...
```{r GODotPlot_up, fig.height=4, fig.width=7, fig.align="center", fig.cap="Infected_vs_Bystander.GO_up"}
...
```{r GODotPlot_down, fig.height=4, fig.width=7, fig.align="center", fig.cap="Infected_vs_Bystander.GO_down"}
scGODotPlot(object = Integrated, 
            key = "Infected_vs_Bystander.GO", 
            ont = "BP", 
            direction = "down", 
...
```{r GOBarPlot_H3N2_up, fig.height=4, fig.width=7, fig.align="center", fig.cap="H3N2pos_vs_H3N2neg.GO_up"}
...
```{r GODotPlot_H3N2_up, fig.height=4, fig.width=7, fig.align="center", fig.cap="H3N2pos_vs_H3N2neg.GO_up"}
scGODotPlot(Integrated, key = "H3N2.GO", clusters = "0", extra = "H3N2", top_n = 6)
```

## Visualization of HALLMARK_INFLAMMATORY_RESPONSE pathway
```{r INFLAMMATORY_RESPONSE, fig.height=3, fig.width=9, fig.align="center", fig.cap = "HALLMARK_INFLAMMATORY_RESPONSE"}
...
```{r TNFA_SIGNALING_VIA_NFKB, fig.height=3, fig.width=9, fig.align="center", fig.cap = "HALLMARK_TNFA_SIGNALING_VIA_NFKB"}
scScoreDimPlot(Integrated, 
...
```{r APOPTOSIS, fig.height=3, fig.width=9, fig.align="center", fig.cap = "HALLMARK_APOPTOSIS"}
scScoreDimPlot(Integrated, 
