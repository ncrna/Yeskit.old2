# Set a default value if the left value is null @param lhs Default value to use
# @param rhs The value to use if lhs is null @author Hadley Wickham @references
